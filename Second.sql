...
CREATE TABLE Clubs(
 ...
 ALTER TABLE Clubs ADD FOREIGN KEY(Stadium_ID) REFERENCES Stadiums(ID);
...
CREATE TABLE Clubs_Statistics(
 ...
 draw_number int
  ...
  ALTER TABLE Clubs_Statistics ADD FOREIGN KEY(Club_ID) REFERENCES Clubs(ID);
...
CREATE TABLE Owners(
 ...
 ALTER TABLE Owners ADD FOREIGN KEY(Club_ID) REFERENCES Clubs(ID);
 ALTER TABLE Owners ADD FOREIGN KEY(Sponsor_ID) REFERENCES Sponsors(ID);
...
CREATE TABLE Transfer(
 ...
 transfer_Date_Over date
   ...
   ALTER TABLE Transfer ADD FOREIGN KEY(Player_ID) REFERENCES Players(ID);
   ALTER TABLE Transfer ADD FOREIGN KEY(Club_ID_From) REFERENCES Clubs(ID);
   ALTER TABLE Transfer ADD FOREIGN KEY(Club_ID_To) REFERENCES Clubs(ID);
...
CREATE TABLE Trainers(
 ...
 dismissal_date date
  ...
  ALTER TABLE Trainers ADD FOREIGN KEY(Club_ID) REFERENCES Clubs(ID);
...
away_score int
  ...
  ALTER TABLE Match ADD FOREIGN KEY(Trainer_ID_First) REFERENCES Trainers(ID);
  ALTER TABLE Match ADD FOREIGN KEY(Trainer_ID_Second) REFERENCES Trainers(ID);
  ALTER TABLE Match ADD FOREIGN KEY(Club_ID_First) REFERENCES Clubs(ID);
  ALTER TABLE Match ADD FOREIGN KEY(Club_ID_Second) REFERENCES Clubs(ID);
  ALTER TABLE Match ADD FOREIGN KEY(Stadium_ID) REFERENCES Stadiums(ID);
...
CONSTRAINT PK_Players_In_Match PRIMARY KEY (Match_ID, Player_ID)
 ...
 ALTER TABLE Players_In_Match ADD FOREIGN KEY(Match_ID) REFERENCES Match(ID);
 ALTER TABLE Players_In_Match ADD FOREIGN KEY(Player_ID) REFERENCES Players(ID);
...
CONSTRAINT PK_Injured_Players PRIMARY KEY (Match_ID, Player_ID)
 ...
 ALTER TABLE Injured_Players ADD FOREIGN KEY(Match_ID) REFERENCES Match(ID);
 ALTER TABLE Injured_Players ADD FOREIGN KEY(Player_ID) REFERENCES Players(ID);
 ...
 INSERT Injured_Players
	(Player_ID, Match_ID, type_of_injury, recovery_time)
 VALUES
	(23, 7, 'Растяжение мышц голени', 7);

 INSERT Injured_Players
	(Player_ID, Match_ID, type_of_injury, recovery_time)
 VALUES
	(70, 5, 'Перелом руки', 50);
...
SELECT * FROM Stadiums
 ...
 VALUES
  ...
  INSERT Owners
	(Club_ID, Sponsor_ID, full_name, date_of_birth, club_Profit, club_Purchase_Date)
 VALUES
	(5, 2, 'Медведев Александр Иванович', '1955-08-14', 167800000, '2019-01-01');

  INSERT Owners
	(Club_ID, Sponsor_ID, full_name, date_of_birth, club_Profit, club_Purchase_Date)
 VALUES
	(6, 5, 'Жозеп Мария Бартомеу-и-Флорета', '1963-02-06', 608000000, '2014-01-23');
 ...
 VALUES
	...
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	( 5,	'Sergio Busquets',	29,	'Spain',	315,	'CDM',	5,	181,	77);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'E. Cavani',	31,	'Uruguay',	200,	'LS',	21,	189,	90);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'M. Neuer',	32,	'Germany',	130,	'GK',	1,	177,	74);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	( 5,	'S. Agüero',	30,	'Argentina',	300,	'ST',	10,	187,	87);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	( 5,	'G. Chiellini',	33,	'Italy',	215,	'LCB',	3,	189,	90);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	( 5,	'K. Mbappé',	19,	'France',	100,	'RM',	10,	166,	70);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	( 5,	'M. Salah',	26,	'Egypt',	255,	'RM',	10,	188,	80);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'Casemiro',	26,	'Brazil',	285,	'CDM',	14,	183,	79);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'J. Rodríguez',	26,	'Colombia',	315,	'LAM',	10,	179,	77);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'L. Insigne',	27,	'Italy',	165,	'LW',	10,	178,	77);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'Isco',	26,	'Spain',	315,	'LW',	22,	168,	70);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'C. Eriksen',	26,	'Denmark',	205,	'CAM',	10,	180,	78);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'Coutinho',	26,	'Brazil',	340,	'LW',	7,	168,	72);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'P. Aubameyang',	29,	'Gabon',	265,	'LM',	14,	177,	77);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'M. Hummels',	29,	'Germany',	160,	'LCB',	5,	188,	88);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'Marcelo',	30,	'Brazil',	285,	'LB',	12,	184,	84);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'G. Bale',	28,	'Wales',	355,	'ST',	11,	177,	77);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'H. Lloris',	31,	'France',	150,	'GK',	1,	190,	90);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'G. Higuaín',	30,	'Argentina',	245,	'LS',	9,	179,	79);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(5,	'Thiago Silva',	33,	'Brazil',	165,	'RCB',	2,	188,	88);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'S. Handanovič',	33,	'Slovenia',	110,	'GK',	1,	174,	74);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'G. Buffon',	40,	'Italy',	77,	'GK',	1,	182,	82);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'S. Umtiti',	24,	'France',	205,	'CB',	23,	194,	90);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'M. Icardi',	25,	'Argentina',	130,	'ST',	9,	189,	89);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'K. Koulibaly',	27,	'Senegal',	115,	'LCB',	26,	169,	72);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'P. Pogba',	25,	'France',	210,	'RDM',	6,	177,	77);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'K. Navas',	31,	'Costa Rica',	195,	'GK',	1,	167,	73);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'R. Lukaku',	25,	'Belgium',	230,	'ST',	9,	182,	82);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'C. Immobile',	28,	'Italy',	115,	'ST',	17,	180,	80);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'Jordi Alba',	29,	'Spain',	250,	'LB',	18,	179,	79);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'D. Mertens',	31,	'Belgium',	135,	'RF',	14,	193,	90);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'J. Vertonghen',	31,	'Belgium',	155,	'LCB',	5,	183,	79);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'M. Hamšík',	30,	'Slovakia',	125,	'LCM',	17,	188,	88);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'I. Rakitić',	30,	'Croatia',	260,	'RCM',	4,	176,	76);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'Piqué',	31,	'Spain',	240,	'RCB',	3,	165,	70);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'L. Sané',	22,	'Germany',	195,	'LW',	19,	188,	88);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'Bernardo Silva',	23,	'Portugal',	180,	'RW',	11,	189,	89);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'Ederson',	24,	'Brazil',	125,	'GK',	31,	187,	80);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'S. Mané',	26,	'Senegal',	195,	'LM',	10,	178,	72);

      INSERT Players
	(Club_ID, name, age, nationality, wage, position_in_team, number_in_team, height, weight)
 VALUES
	(6,	'V. van Dijk',	26,	'Netherlands',	165,	'LCB',	4,	187,	83);
 ...
 VALUES
	...
	(Club_ID, full_name, date_of_birth, position, wage, date_of_appointment)
 VALUES
	(5, 'Семак Сергей Богданович', '1976-02-27', 'Главный тренер', 2000000, '2018-05-29');

    INSERT Trainers
	(Club_ID, full_name, date_of_birth, position, wage, date_of_appointment)
 VALUES
	(6, 'Вальверде Эрнесто', '1964-02-09', 'Тренер', 3500000, '2017-01-01');
 ...
 VALUES
	(1,	6,	1,	2000000, '2018-05-06',	'2018-12-12');

      INSERT Transfer
	(Player_ID, Club_ID_From, Club_ID_To, transition_Cost, transfer_Date_Start, transfer_Date_Over)
 VALUES
	(56,	1,	6,	2500000, '2019-05-06',	NULL);

      INSERT Transfer
	(Player_ID, Club_ID_From, Club_ID_To, transition_Cost, transfer_Date_Start, transfer_Date_Over)
 VALUES
	(30,	4,	5,	1000000, '2018-05-06',	'2019-01-01');
...
SELECT * FROM Transfer;
 ...
 VALUES
	(1, 6, 1, 3, 1, '2019-05-23T14:25:10', 2, 1);
 ...
 INSERT Match
	(Club_ID_First, Club_ID_Second, Trainer_ID_First, Trainer_ID_Second, Stadium_ID, date_of_match, home_score, away_score)
 VALUES
	(1, 5, 1, 2, 1, '2019-06-23T14:25:10', 1, 0);


 INSERT Match
	(Club_ID_First, Club_ID_Second, Trainer_ID_First, Trainer_ID_Second, Stadium_ID, date_of_match, home_score, away_score)
 VALUES
	(6, 4, 3, 4, 6, '2019-05-23T18:25:10', 3, 2);

 INSERT Match
	(Club_ID_First, Club_ID_Second, Trainer_ID_First, Trainer_ID_Second, Stadium_ID, date_of_match, home_score, away_score)
 VALUES
	(6, 5, 3, 2, 5, '2019-07-23T15:25:10', 2, 0);

INSERT Match
	(Club_ID_First, Club_ID_Second, Trainer_ID_First, Trainer_ID_Second, Stadium_ID, date_of_match, home_score, away_score)
 VALUES
	(4, 5, 4, 2, 4, '2019-05-17T14:25:10', 1, 1);
...
INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 61, 'Primary', 'CAM', 2, 2, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 62, 'Primary', 'CB', 0, 1, 1, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 63, 'Primary', 'CDM', 0, 1, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 64, 'Primary', 'CF', 0, 1, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 65, 'Primary', 'CM', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 66, 'Primary', 'GK', 0, 1, 1, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 67, 'Primary', 'LAM', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 68, 'Primary', 'LB', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 69, 'Primary', 'LCB', 0, 3, 1, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 70, 'Primary', 'ST', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 71, 'Primary', 'RF', 0, 1, 1, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 72, 'Alternate', 'RF', 0, 1, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 73, 'Alternate', 'LB', 0, 2, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 74, 'Alternate', 'GK', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(5, 75, 'Reserve', 'ST', 0, 0, 0, 0);
...
INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 41, 'Primary', 'CAM', 0, 2, 1, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 42, 'Primary', 'CB', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 43, 'Primary', 'CDM', 0, 2, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 44, 'Primary', 'CF', 0, 2, 2, 1);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 45, 'Primary', 'CM', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 46, 'Primary', 'GK', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 47, 'Primary', 'LAM', 0, 1, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 48, 'Primary', 'LB', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 49, 'Primary', 'LCB', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 50, 'Primary', 'ST', 1, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 51, 'Primary', 'RF', 0, 0, 0, 0);


INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 52, 'Alternate', 'CF', 1, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 54, 'Alternate', 'GK', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 55, 'Alternate', 'CAM', 0, 1, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(6, 56, 'Reserve', 'CF', 0, 0, 0, 0);
...
INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 61, 'Primary', 'CAM', 0, 2, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 62, 'Primary', 'CB', 0, 1, 1, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 63, 'Primary', 'CDM', 1, 1, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 64, 'Primary', 'CF', 0, 1, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 65, 'Primary', 'CM', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 66, 'Primary', 'GK', 0, 1, 1, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 67, 'Primary', 'LAM', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 68, 'Primary', 'LB', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 69, 'Primary', 'LCB', 0, 3, 1, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 70, 'Primary', 'ST', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 71, 'Primary', 'RF', 0, 1, 1, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 72, 'Alternate', 'RF', 0, 1, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 73, 'Alternate', 'LB', 0, 2, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 74, 'Alternate', 'GK', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 75, 'Reserve', 'ST', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 21, 'Primary', 'CAM', 0, 2, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 22, 'Primary', 'CB', 0, 1, 1, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 23, 'Primary', 'CDM', 0, 1, 0, 1);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 24, 'Primary', 'CF', 1, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 25, 'Primary', 'CM', 0, 1, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 26, 'Primary', 'GK', 0, 1, 1, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 27, 'Primary', 'LAM', 0, 2, 2, 1);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 28, 'Primary', 'LB', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 29, 'Primary', 'LCB', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 30, 'Primary', 'ST', 0, 2, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 31, 'Primary', 'RF', 0, 2, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 32, 'Alternate', 'LAM', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 33, 'Alternate', 'CDM', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 34, 'Alternate', 'GK', 0, 0, 0, 0);

INSERT Players_In_Match
	(Match_ID, Player_ID, composition, position_in_match, number_of_goals, number_of_violations, number_of_yellow_cards, number_of_red_cards)
 VALUES
	(7, 35, 'Reserve', 'LAM', 0, 0, 0, 0);
 ...
 SELECT number_of_goals FROM Players_In_Match
 Where number_of_goals = 2 OR number_of_goals = 1;
